...
hitable *final() {
	...
	list[l++] = new sphere(vec3(260, 150, 45), 50, new dielectric(vec3(1,1,1),1.5));
	list[l++] = new sphere(vec3(0, 150, 145), 50, new metal(vec3(0.8, 0.8, 0.9), 10.0));
	hitable *boundary = new sphere(vec3(360, 150, 145), 70, new dielectric(vec3(1,1,1),1.5));
	list[l++] = boundary;
	//list[l++] = new constant_medium(boundary, 0.2, new constant_texture(vec3(0.2, 0.4, 0.9)));
	boundary = new sphere(vec3(0, 0, 0), 5000, new dielectric(vec3(1,1,1),1.5));
